<script type="text/javascript" src="../js/entrega.js?rev=<?php echo time();?>"></script>
<div class="col-md-12">
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
              <h3 class="box-title">ENTREGAS DE ACTIVIDADES</h3>
            ...
            <table id="tabla_entrega" class="display responsive nowrap" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Proyecto</th>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <div class="modal-header" style="background:#3c8dbc; color:white">
            ...
            <h4 class="modal-title">Ver Entregas de la Actividad</h4>
